...
// START CONFIGURATION
	...
	include_once($_SERVER['DOCUMENT_ROOT'] . '/tourcms/tourcms-php-1.7/tourcms.php');
	...
	$response_url = "https://bookings.essentialworld.travel/master/step3.php";
